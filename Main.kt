...
class MaleStudent(course: String, private val footballFeedback: String, private val curriculum: String) : Student("Male", course) {
...
class FemaleStudent(course: String, private val hockeyFeedback: String, private val curriculum: String) : Student("Female", course) {
    override fun feedback(): String {
